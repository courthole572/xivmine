...
>Written By:
>Sykes Two@Kraken, Nienne Wynstone@Kraken
...
Shortly after ***Hellfire***, ***Radiant Plume*** will cast over the arena leaving 2 small safe spots. The first safe spots are at markers A and 1 and then they rotate clockwise each time it appears. This is followed by ***Crimson Cyclone***. Four Ifrit clones will appear around the arena with he first being slightly clockwise of marker C. This one will dash first followed by the other three in order. Simply stand at C and move along the wall clockwise as the clones disappear. The searing wind healer has it a bit tougher, they will need to stand on the fourth clone and then move clockwise along the wall after the first clone dashes.  
